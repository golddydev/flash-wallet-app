    ...
    <View
      ...
      <View>
        <View style={{ paddingHorizontal: 24, alignItems: 'center' }}>
          <Text style={{ color: colors.primary5, ...fonts.title2 }}>Confirm Seed Phrase</Text>
        </View>
        ...
        <View
          ...
          {curAns ? (
            <Text style={{ ...fonts.big_type1, color: colors.primary5 }}>
        ...
        <View
          ...
          <View
            style={{
              ...
              borderRadius: 8,
              backgroundColor:
                step === 1 || step === 2 ? colors.primary5 : colors.grey23,
              marginRight: 8,
            }}></View>
          <View
            style={{
              ...
              height: 8,
              borderRadius: 8,
              backgroundColor: step === 2 ? colors.primary5 : colors.grey23,
              marginRight: 8,
            }}></View>
          <View
            style={{
