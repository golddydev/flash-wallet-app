...
const image = require('../../assets/images/createwallet/image.png');
...
const CreateWalletScreen = ({ navigation, createWallet }) => {
    ...
    return (
      <View style={{ height: '100%' }}>
        ...
        <View style={{ width: '100%', alignItems: 'center', paddingTop: 40 }}>
          <View>
            <Text style={{ ...fonts.title2, color: colors.primary5 }}>Create Password</Text>
          </View>
          <View>
            <Text
              style={{
              ...
              This password will unlock your Flash Wallet only on this service.
            </Text>
          </View>
        </View>
        ...
        <View
          ...
          <View
            ...
            <Text
              ...
              I understand that Flash Wallet cannot recover this password for me.{' '}
              <Text
  ...
  const secureWalletRender = () => {
    return (
      <View style={{ flex: 1, }}>
        ...
        <View style={{ flex: 1 }}>
          <View style={{ width: '100%', alignItems: 'center', paddingTop: 128, paddingBottom: 60 }}>
            <Image source={image} />
          </View>
  ...
  const secureSeedRender = () => {
    return (
      <View style={{ width: '100%', paddingTop: 40, height: '100%', direction: 'column', display: 'flex' }}>
        <RBSheet
          height={360}
      ...
      <View style={{ width: '100%', paddingTop: 40, height: '100%' }}>
        <View style={{ alignItems: 'center', paddingHorizontal: 24 }}>
          <Text style={{
            color: colors.primary5,
            ...fonts.title2
          }}>Write Down Your Seed Phrase</Text>
        </View>
