      ...
      <TouchableOpacity
        ...
        <View
          ...
          <View
            ...
            <Text style={{ ...fonts.HEADINGS_H4, color: 'white' }}>
              {networkName}
            </Text>
          </View>
          {isSelected && (
      ...
      <TouchableOpacity
        ...
        <View
          ...
          <View
            ...
            <View>
              <View>
                <Text style={{ ...fonts.HEADINGS_H2, color: 'white' }}>
                  {accountName}
                </Text>
              </View>
              <View>
      ...
      <RBSheet
        ...
        <ScrollView style={{ marginBottom: 40 }}>
          <View style={{ paddingTop: 12 }}>
            <Text
              style={{ ...fonts.HEADINGS_H2, color: 'white', textAlign: 'center' }}>
              Network
            </Text>
          </View>
          ...
          <View style={{ paddingTop: 24, paddingHorizontal: 24 }}>
            <Text style={{ ...fonts.HEADINGS_H2, color: colors.grey9 }}>
              Other Network
            </Text>
        ...
        <View>
          ...
          <View
            ...
            <Text style={{ ...fonts.caption_large_regular, color: 'white' }}>
              ...
              recoverable with your Flash Wallet seed phrase.
            </Text>
          </View>
          <View
            style={{
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <View
            ...
            <Text style={{ ...fonts.BODY_T3, color: 'white' }}>
              {networks && currentNetwork
