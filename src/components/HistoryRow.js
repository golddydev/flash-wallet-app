    ...
    <TouchableOpacity
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center' }}>
        <View>
          ...
          /> */}
          <View style={{ padding: 12, borderRadius: 24, backgroundColor: colors.BG, marginRight: 16 }}>
            <SvgXml xml={transactionType === 'received' ? fonts.topReceiveButtonSvgXml : fonts.sendTokenSvgXml} />
          </View>
